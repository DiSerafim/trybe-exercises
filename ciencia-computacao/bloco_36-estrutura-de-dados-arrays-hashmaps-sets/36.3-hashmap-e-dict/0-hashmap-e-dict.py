...
# Se você adicionar uma nova contratação à lista de subordinadas, a estrutura que você fez no follow-up-1(ex3.py) está desatualizada.
# Modifique suas funções para que essa estrutura seja atualizada junto com a adição de uma nova contratação.
# Faça isso sem rodar de novo a função score() e lembre-se de atualizar todos os scores desde a pessoa da presidência até a equipe que a nova contratação entrou.
""" ex4.py """
...
# Problema do vídeo: Find the duplicate number
# https://leetcode.com/problems/find-the-duplicate-number/

# Implementação das hashmap do Python (o código está em linguagem C, mas há uma explicação detalhada da implementação em inglês)
# https://github.com/python/cpython/blob/master/Objects/dictobject.c

# Como fazer com que classes criadas por você possam ser usadas como chave
