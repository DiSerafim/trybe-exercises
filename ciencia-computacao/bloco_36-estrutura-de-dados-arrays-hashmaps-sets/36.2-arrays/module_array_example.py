...
""" Resultado """ 
# python3 module_array_example.py 

# Após adicionar alguns valores:  array('I', [5, 3, 5])
# Após inserção em índice intermediário:  array('I', [5, 4, 3, 5])
# Após remover um valor: array('I', [4, 3, 5])
