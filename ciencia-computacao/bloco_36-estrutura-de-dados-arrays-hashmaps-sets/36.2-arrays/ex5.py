...
servidores =  [[1,0],[0,1]]
print(f"resultado:", count_servers(servidores))  # 0
# Linhas e colunas são diferentes.
servidores = [[1,0],[1,1]]
print(f"resultado:", count_servers(servidores))  # 3
# Todos os servidores se comunicam com ao menos um outro servidor.
servidores = [[1, 0, 0],
              [1, 0, 0],
              [0, 0, 1]]
print(f"resultado:", count_servers(servidores))  # 2
print(f"O servidor de índice {servidores[2],servidores[2]} não possui nenhum outro na mesma linha e coluna.")