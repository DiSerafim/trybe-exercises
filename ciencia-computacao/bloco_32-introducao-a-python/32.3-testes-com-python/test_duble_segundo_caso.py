# substituir o método open em tempo de execução por um objeto mock_open , que
# já vem embutido na linguagem e se comporta como o open , retornando o que foi
# definido em read_data como seu conteúdo.

import json
from unittest.mock import mock_open, patch
from duble_segundo_caso import retrieve_pokemons_by_type
