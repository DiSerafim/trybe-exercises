# leitor e escritor baseado em dicionários. Sua principal vantagem é que, com
# ele, não precisamos manipular os índices para acessar os dados das colunas.
# Mas, devido a estrutura de dados utilizada, ele tem como desvantagem o
# espaço ocupado em memória, sendo maior que o comum:
...
with open("balneabilidade.csv") as file:
    ...
    # a linha de cabaçalhos é utilizada como chave do dicionário
...
with open("report_por_camapanha_dicionarios.csv", "w") as file:
    ...
    # É necessário passar o arquivo e o cabaçalho
